...
final class DB {
    ...
    * @return ?T
    */
    public static function find_by_id(string $class_name, mixed $id): mixed {
        ...
        return self::map_columns($properties, $class_name, $row);
    }
    ...
    * @return T[]
    */
    public static function find_all(string $class_name): array {
        /** @var ReflectionClass<T> $r */
        $r = new ReflectionClass($class_name);
        $ar_attr = self::get_ar_attribute($r);
        Error::assert(isset($ar_attr), __METHOD__.": No ActiveRecord attribute on class {$class_name}", __FILE__, __LINE__);
    ...
    * @param class-string<\T> $class_name
    */
    public static function delete_by_id(string $class_name, mixed $id): int {
        /** @var ReflectionClass<T> $r */
        $r = new ReflectionClass($class_name);
        $ar_attr = self::get_ar_attribute($r);
        Error::assert(isset($ar_attr), __METHOD__.": No ActiveRecord attribute on class {$class_name}", __FILE__, __LINE__);
    ...
    * @param T $class_obj
    */
    public static function insert(mixed $class_obj): bool {
        /** @var ReflectionClass<T> $r */
    ...
    * @param T $class_obj
    */
    public static function update_by_id(mixed $class_obj): bool {
        /** @var ReflectionClass<T> $r */
        $r = new ReflectionClass($class_obj);
        $ar_attr = self::get_ar_attribute($r);
        $class_name = $class_obj::class;
